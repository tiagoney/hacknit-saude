...
<img src="foto.jpg" height="100" width="100"> <br>

<img src="nomee.jpg"><input type="text" title="Coloque seu nome" placeholder="Nome" required size="70" name="nome" autofocus value="<?php echo $row["nome"]; ?>"> <br>

<img src="ida.jpg"><H2>5 meses</H2>
<BR><BR>

		Vacina:<br> Data para tomar:<br>

		<img src="vctj.jpg"><img src="dtv.jpg"><img src="xxt.jpg">

<A HREF="postos.php"><img src="vvvv.jpg">
