...
<BR><BR>
&nbsp; <A HREF="estoquevacinas.php"><FONT COLOR=WHITE><B>Controle de estoque</B></FONT></A><BR>
...
<img src="agbanner.jpg">
<A HREF="cadvac.php"><img src="digital.jpg">
...
<div class="login-page">
  <div class="form">
    <form class="register-form" type="Post" action="registrovacinador.php">
      <input type="" placeholder="matricula" value="<?php echo $row["matricula"]; ?>">
      <input type="password" placeholder="password"value="<?php echo $row["password"]; ?>">
      <button type="submit">Entrar</button>
      <p class="message"> Sem registro? <a href="#">Clique aqui</a></p>
